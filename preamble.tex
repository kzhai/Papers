...
\ifcomment
\newcommand{\redcomment}[1]{\colorbox{red}{ \parbox{.9\linewidth}{ #1 } } }
\newcommand{\greencomment}[1]{ \colorbox{green}{ \parbox{.9\linewidth}{ #1 } } }
\newcommand{\bluecomment}[1]{ \colorbox{blue}{ \parbox{.9\linewidth}{ #1 } } }
\newcommand{\reviewercomment}[1]{ \colorbox{yellow}{ \parbox{.9\linewidth}{ #1 } } }
\else
\newcommand{\redcomment}[1]{ }
\newcommand{\greencomment}[1]{ }
